    ...
    <el-container>
      <el-header style="font-size: 12px; border-bottom: 1px solid #ccc; text-align: right; display: flex">
        ...
        <div class="toolbar" style="width: 80px">
          <el-dropdown>
            <el-avatar src="https://cube.elemecdn.com/0/88/03b0d39583f48206768a7534e55bcpng.png" :size="40" style="margin-top: 5px"></el-avatar>
            <template #dropdown>
              <el-dropdown-menu>
                <div style="text-align: center; padding: 10px 10px">
                  <b
                    ><i>{{ local_username }}</i></b
                  >
                </div>
...
const outLogin = () => {
  ElMessageBox.confirm("确定退出当前登录状态吗？", "Warning", {
