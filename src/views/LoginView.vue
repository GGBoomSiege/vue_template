            ...
            <el-form :model="formData" :rules="rules" ref="formDataRef">
                ...
                <el-form-item label="">
                    <div class="check-code-panel">
                        <div class="row">
                            <el-form-item label="">
                                <el-input placeholder="请输入验证码" v-model="formData.checkCode" size="large" clearable></el-input>
                            </el-form-item>
                            <!-- 使用验证码组件 -->
...
.row {
    display: flex;
    align-items: center; /* 或其他合适的对齐方式 */
    height: 38px; /* 强制限定高度为 38px */
